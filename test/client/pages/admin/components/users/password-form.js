...
const Form = Proxyquire('../../../../../../client/pages/admin/components/users/password-form', {
...
lab.experiment('Admin User Password Form', () => {
    ...
    lab.test('it replaces state when receiving new props when hydrated is false', (done) => {
