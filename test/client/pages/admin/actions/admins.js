...
const Actions = Proxyquire('../../../../../client/pages/admin/actions/admin', {
    'flux-dispatcher': stub.Dispatcher,
    '../../../helpers/json-fetch': stub.Fetch
});


lab.experiment('Admin Admin Actions', () => {
    ...
    lab.test('it handles saveGroups successfully', (done) => {
    ...
    lab.test('it handles saveGroups when xhr fails', (done) => {
    ...
    lab.test('it handles savePermissions successfully', (done) => {
    ...
    lab.test('it handles savePermissions when xhr fails', (done) => {
