...
const Actions = Proxyquire('../../../../../client/pages/admin/actions/user', {
    'flux-dispatcher': stub.Dispatcher,
    '../../../helpers/json-fetch': stub.Fetch
});


lab.experiment('Admin User Actions', () => {
    ...
    lab.test('it handles getIdentity successfully', (done) => {
    ...
    lab.test('it handles getIdentity when xhr fails', (done) => {
    ...
    lab.test('it handles saveIdentity successfully', (done) => {
    ...
    lab.test('it handles saveIdentity when xhr fails', (done) => {
    ...
    lab.test('it handles savePassword successfully', (done) => {
    ...
    lab.test('it handles savePassword when password match fails', (done) => {
    ...
    lab.test('it handles savePassword when xhr fails', (done) => {
