...
const Form = Proxyquire('../../../../../../client/pages/account/components/settings/account-form.jsx', {
    '../../actions': stub.Actions
});


lab.experiment('Account Settings Account Form', () => {
    ...
    lab.test('it updates props to with new input state data', (done) => {
        ...
        FormEl = React.createElement(Form, { name: {} });
        ReactDOM.render(FormEl, container);
